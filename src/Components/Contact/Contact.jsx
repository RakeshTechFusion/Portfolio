            ...
            <Box className={styles.infoContainer}>
                <Box className={styles.linksBox}>
                    <Button
                        ...
                        onClick={()=>newTab("https://www.linkedin.com/in/rakesh-kumar-swain-8259a7164/")}
                    >
                        LinkedIn
                    </Button>
                    <Button
                        ...
                        onClick={()=>newTab("https://github.com/SWAIN1998")}
                    >
                        GitHub
                    </Button>   
                    <Button                     
                        ...
                        startIcon={< EmailIcon/>}
                    >
                        <a href="swainrakeshkumar60@gmail.com" className={styles.dTag} download>
                            Email
                        </a>
                    </Button>
                    <Button
